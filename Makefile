...
OBJECTS = $(OBJECT_PATH)/Cube.o $(OBJECT_PATH)/Tables.o $(OBJECT_PATH)/Solver.o $(OBJECT_PATH)/Main.o
...
DB_RELATED_TEST_OBJECT = $(OBJECT_PATH)/Cube.o $(OBJECT_PATH)/Tables.o $(OBJECT_PATH)/Solver.o $(OBJECT_PATH)/DatabaseTests.o
...
$(BIN_PATH)/$(DB_RELATED_TEST_TARGET): $(DB_RELATED_TEST_OBJECT) | $(BIN_PATH)
	$(CXX) $(CXXFLAGS) $(DB_RELATED_TEST_OBJECT) -o $@ $(GTEST_FLAGS)
...
clean:
	rm -f $(OBJECT_PATH)/*.o $(BIN_PATH)/$(TARGET) $(BIN_PATH)/$(COORDS_TEST_TARGET) $(BIN_PATH)/$(ROTATION_TEST_TARGET) $(BIN_PATH)/$(DB_RELATED_TEST_TARGET)
...
.PHONY: run clean TestAll test_coords test_rotations test_solves