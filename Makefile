...
clean:
	rm -f $(OBJECT_PATH)/*.o $(BIN_PATH)/$(TARGET) $(BIN_PATH)/$(TARGET_DOCKER_SINGLE) $(BIN_PATH)/$(COORDS_TEST_TARGET) $(BIN_PATH)/$(ROTATION_TEST_TARGET) $(BIN_PATH)/$(DB_RELATED_TEST_TARGET) $(TABLE_PATH)/*.bin
